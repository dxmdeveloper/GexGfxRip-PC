...
static void cb_on_intro_obj_found(void *clientp, const void *headers, const void *bitmap, const struct gfx_palette *palette,
				  u32 iterations[static 4], struct gfx_properties *);
...
inline static void on_gfx_found_body(void *clientp, const void *headers, const void *bitmap, const struct gfx_palette *palette,
				     uint iterations[4], bool *isdircreatedflagp, const char *subdir, const char *filename_format)
{
	...
	*isdircreatedflagp = true;
    ...
    snprintf(filePath, PATH_MAX, fformat, packp->app_options->save_path, subdir, iterations[0], iterations[1], iterations[2],
	     iterations[3]);
    draw_img_and_create_png(headers, bitmap, palette, filePath);
}
...
{
    on_gfx_found_body(clientp, headers, bitmap, palette, iterations, &((struct onfound_pack *)clientp)->is_obj_gfx_dir_created, "objects",
		      "%u-%u-%u-%u.png");
}

void cb_on_intro_obj_found(void *clientp, const void *headers, const void *bitmap, const struct gfx_palette *palette, u32 iterations[4],
			   struct gfx_properties *gfx_props)
{
    on_gfx_found_body(clientp, headers, bitmap, palette, iterations, &((struct onfound_pack *)clientp)->is_intro_dir_created, "intro",
		      "%u-%u-%u-%u.png");
}

void cb_on_backgrounds_found(void *clientp, const void *headers, const void *bitmap, const struct gfx_palette *palette, u32 iterations[4],
			     struct gfx_properties *gfx_props)
{
    on_gfx_found_body(clientp, headers, bitmap, palette, iterations, &((struct onfound_pack *)clientp)->is_bg_dir_created, "backgrounds",
		      "%u-%u-%u-%u.png");
}